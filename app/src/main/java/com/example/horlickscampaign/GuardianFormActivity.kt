...
import com.example.horlickscampaign.databinding.ActivityGuardianFormBinding
...
class GuardianFormActivity : AppCompatActivity() {
    ...
    lateinit var binding: ActivityGuardianFormBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(sharedPreferences.contains("savedSchool")){
            ...
            binding.spinnerRelation.adapter =
                ArrayAdapter(this, R.layout.spinner_item, relationList)
            binding.spinnerRelation.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
                override fun onItemSelected(
                    ...
                    binding.relationOther.visibility = View.GONE
                    if (position == 0){
                        relation = "Father"
                    }
                    else if (position == 1) {
                        ...
                        relation = "Other"
                        binding.relationOther.visibility = View.VISIBLE
                    }
                }
    ...
    private fun clearForm()
    {
        ...
        studentClass = ""
        binding.guardianName.setText("")
        GuardianName = ""
        binding.contactPersonMobileNumber.setText("")
        isCorrectPrimaryNumber = false
        guardianNumber = ""
        binding.relationOther.setText("")
        relation = "Father"
    }
    ...
    private fun upload() {
        ...
        val url = StaticTags.BASE_URL + "activities/insert_gurdian_info.php"
        ...
        val sr: StringRequest = object : StringRequest(Method.POST, url,
            ...
            override fun getParams(): Map<String, String> {
                ...
                params["Name"] = binding.guardianName.text.toString()
                params["Class"] = studentClass
                params["Sex"] = guardianSex
    ...
    private fun checkDuplicate(number: String) {
        if (CustomUtility.haveNetworkConnection(this)) {
            ...
            url+="activities/check_grdn_mobile_exist.php"
        ...
        if (CustomUtility.haveNetworkConnection(this)) {
            if (!CustomUtility.haveNetworkConnection(this)) {
                Toast.makeText(this, "No internet connection!", Toast.LENGTH_SHORT)
                    .show()
                return false
            } else if (binding.guardianName.text.toString() == "") {
                Toast.makeText(this, "Please fill required fields!", Toast.LENGTH_SHORT)
                    .show()
                binding.guardianName.error = "Required Field!"
                return false
            }  else if (guardianSex == "") {
                Toast.makeText(this, "Please select guardian's sex type!", Toast.LENGTH_SHORT)
                    .show()
                return false
            ...
            else if (relation == "Other" && binding.relationOther.text.toString() == "") {
                Toast.makeText(this, "Please specify other relation!", Toast.LENGTH_SHORT)
                    .show()
                binding.relationOther.error = "Required Field!"
                return false
            }
            return true
        } else {
